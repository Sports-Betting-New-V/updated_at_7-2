import { users, games, predictions, bets, type User, type InsertUser, type UpsertUser, type Game, type InsertGame, type Prediction, type InsertPrediction, type Bet, type InsertBet, type GameWithPredictions, type BetWithGame, type UserStats } from "@shared/schema";
